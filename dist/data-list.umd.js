(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('babel-runtime/regenerator'), require('babel-runtime/helpers/toConsumableArray'), require('babel-runtime/helpers/asyncToGenerator'), require('vue-infinite-loading'), require('qs'), require('lodash.get')) :
  typeof define === 'function' && define.amd ? define(['exports', 'babel-runtime/regenerator', 'babel-runtime/helpers/toConsumableArray', 'babel-runtime/helpers/asyncToGenerator', 'vue-infinite-loading', 'qs', 'lodash.get'], factory) :
  (factory((global.DataList = {}),global._regeneratorRuntime,global._toConsumableArray,global._asyncToGenerator,global.InfiniteLoading,global.qs,global._get));
}(this, (function (exports,_regeneratorRuntime,_toConsumableArray,_asyncToGenerator,InfiniteLoading,qs,_get) { 'use strict';
  ...
  InfiniteLoading = InfiniteLoading && InfiniteLoading.hasOwnProperty('default') ? InfiniteLoading['default'] : InfiniteLoading;
